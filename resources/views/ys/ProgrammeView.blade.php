...
<head>
    ...
    <title>Programme View Table</title>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i->programme_id}}</td>
                            <td>{{$i->programme_name}}</td>
                            <td><a href='student/{{$i->programme_id}}'>Check Students</a></td>
                            <td><a href='course/{{$i->programme_id}}'>Check Courses</a></td>
                        </tr>
