...
<head>
    ...
    <title>Student View Table</title>
...
<div class="modal fade" id="UpdatePersonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <!-- End Update Person Modal -->
    ...
    <div class="content">
        ...
        <div style='background-color:white;width:200px;height:30px;text-align:center;margin-left:20px;'>
                <span style='margin-right:15px;'><b>Filter :&nbsp;&nbsp;Group </b></span>
                <input type ='text' id='group' style='width:30px;height:20px;'>
                <img src='/Images/search.png' id='submit' width="15" height="15">
             </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','#submit',function(){
                ...
                window.location.href="?class="+group;
            });
        })
